...
const termsAndConditions = {
    term1: `제1장 총칙
    제1조 (목적) 이 약관은 주식회사 약쏙(이하 “회사”라 합니다)가 운영하는 “애플리케이션”(이하 “애플리케이션”을 “APP”이라고 합니다)의 서비스 이용 및 제공에 관한 제반 사항의 규정을 목적으로 합니다.
    ...
    term2: `이 약관은 주식회사 약쏙(이하 “회사”라 합니다)가 운영하는 “애플리케이션”(이하 “애플리케이션”을 “APP”이라고 합니다) 이용자의 개인정보 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
    회사는 개인정보처리방침의 지속적인 개선을 위하여 개인정보처리방침을 개정하는데 필요한 절차를 정하고 있습니다. 그리고 본 처리방침은 수시로 내용이 변결될 수 잇으니 정기적으로 방문하여 확인하시기 바랍니다.
    제1조(개인정보의 수집 및 이용목적)
    ① 개인정보 수집 및 이용목적
    본인확인에 따른 서비스 부정이용 방지, 각종고지 · 통지, 고충처리, 분쟁조정을 위한 기록 보존 등을 목적으로 개인정보를 처리합니다.
    보험계약의 상세 가입 현황 서비스 제공 및 본인인증 등을 위한 목적으로 개인정보를 처리합니다.
    전화, 방문 등을 통한 유익한 정보의 제공, 금융상품 소개 및 가입권유, 상담신청에 대한 응대, 재무설계서비스 및 기타서비스의 제공·안내, 보험설계사 소개, 접속빈도 파악 또는 회원의 서비스 이용에 대한 통계 등 회사의 정상적인 영업에 관계된 행위의 목적으로 개인정보를 처리합니다.
    ② 수집 및 이용하는 개인정보 항목
    1. 본인인증 : 성명, 생년월일, 연락처
    보장분석서비스(한국신용정보원 보험계약 조회시) : 한국신용정보원 회원ID, 한국신용정보원 비밀번호(한국신용정보원 회원가입 및 보험계약 조회시에만 활용되며 별도 보관되지 않고 회원가입 절차 및 조회 완료 즉시 파기 됩니다), 성별, 생년월일, 보험계약정보, 주민등록번호(한국신용정보원 본인인증시만 활용되면 별도 보관되지 않고 본인인증이 완료된 경우 즉시 파기됩니다)
    ③ 수집방법
    1. “APP”에 마련된 개인정보 및 보험계약정보 입력란에 본인이 직접 입력하는 방식
    한국신용정보원 보험계약 조회를 통한 방식
    실명확인을 위하여 마련된 대체수단에 직접 입력하는 방식
    생성정보 수집 툴을 이용한 “APP”이용 로그 기록 자동수집
    제2조(개인정보의 보유 및 이용기간)
    ① 회사는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용 기간 내에서 개인정보를 처리·보유합니다.
    ② 개인정보 처리 및 보유 기간은 다음과 같습니다.
    보유 및 이용기간 : 회원 탈회 또는 개인정보의 수집·이용 등에 대한 동의를 철회할 때까지
    기타 법률에 의해 이용자의 개인정보를 보존해야 할 필요가 있는 경우에는 해당 법률의 규정에 따릅니다.
    정보통신망 이용촉진 및 정보보호에 등에 관한 법률에 따라 “APP”를 1년간 로그인하지 아니하는 회원의 개인정보를 보호하기 위하여 개인정보 분리보관 또는 파기 등 필요한 조치를 취합니다.
    제3조(개인정보처리 위탁)
    ① 회사는 원활한 서비스 이행을 위해 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
    위탁하는 업무의 내용 : 애플리케이션 유지·관리
    위탁받는 자 : 주식회사 파인랩, 주식회사 콘캣
    위탁받는 자 연락처 : 파인랩:kwak914@gmail;.com, 콘캣:jyk@concat.kr
    ② 회사는 별도의 금융상품 소개 등 마케팅 활용 동의를 하신 분에 한하여 금융상품의 소개 등을 위해 다음과 같이 개인정보를 처리 위탁하고 있습니다.
    위탁하는 업무의 내용 : 상담신청에 대한 응대, 전화․방문 등을 통한 금융상품 소개, 재무설계서비스 등 회사의 정상적인 영업에 관계된 행위
    ...
    쿠키의 사용 목적 : 이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공 및 타겟 마케팅을 위해 사용됩니다.
    ...
    term3: `보장분석서비스, 회원만을 위한 컨텐츠 제공 등 위해 필요한 최소한의 개인정보를 수집하고 있습니다. 이에 개인정보의 수집 및 이용에 관하여 아래와 같이 고지하오니 충분히 읽어보신 후 동의하여 주시기 바랍니다.
    1. 수집 및 이용목적
    ...
    ·기타 법률에 의해 이용자의 개인정보를 보존해야 할 필요가 있는 경우에는 해당 법률의 규정에 따릅니다.
    ·정보통신망 이용촉진 및 정보보 등에 관한 법률에 따라 APP을 대통령령으로 정하는 기간동안 로그인하지 아니하는 이용자의 개인정보를 보호하기 위하여 개인정보 파기 등 필요한 조치를 취합니다. APP 회원은 1년간 미로그인시 회원정보 삭제 또는 분리보관 및 탈퇴 또는 이용정지처리가 됩니다. 이용자의 요청에 따라 달리 정한 경우가 있을 경우, 달리 정한 기간을 적용할 수 있습니다.`,
  }
